  ...
  return (
    <AbsoluteFill style={{
      ...
      <div style={{
        ...
        {logoBase64 ? (
          <Img src={logoBase64} style={{
            width: 72, height: 72, borderRadius: 20, objectFit: 'contain',
          ...
          <div style={{
            ...
            fontSize: 36, boxShadow: SHADOWS.md,
          }}>🚀</div>
        )}
        <span style={{
          fontFamily: FONTS.heading, fontSize: 40, fontWeight: 800,
      ...
      <div style={{
        ...
        textAlign: 'center', zIndex: 10, maxWidth: 800,
      }}>
        <h2 style={{
          margin: 0, fontSize: 52, fontWeight: 800, color: COLORS.text,
          lineHeight: 1.2, fontFamily: FONTS.heading, letterSpacing: -1,
        }}>{data?.ctaTitle || 'Work Smarter, Not Harder'}</h2>
        <p style={{
          margin: '20px 0 0', fontSize: 24, color: COLORS.muted,
          lineHeight: 1.5, fontWeight: 400,
        }}>{data?.ctaSubtitle || 'Join thousands of digital workers solving problems with AI & modern tools.'}</p>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          background: `linear-gradient(135deg, ${gradient[0]}, ${gradient[1]})`,
          color: COLORS.white, padding: '22px 52px', borderRadius: 16,
          fontSize: 24, fontWeight: 700, fontFamily: FONTS.heading,
          boxShadow: `0 10px 30px ${gradient[0]}40, ${SHADOWS.md}`,
          letterSpacing: 0.5, display: 'flex', alignItems: 'center', gap: 12,
        }}>
          {logoBase64 && <Img src={logoBase64} style={{ width: 32, height: 32, borderRadius: 8, objectFit: 'contain' }} />}
      ...
      <div style={{
        opacity: contentOpacity,
        transform: `translateY(${contentY}px)`,
        display: 'flex', gap: 28, marginTop: 24, zIndex: 10,
      }}>
        {['AI Tools', 'Productivity', 'Freelancing'].map((tag, i) => (
          <div key={i} style={{
            display: 'flex', alignItems: 'center', gap: 8,
            fontSize: 16, color: COLORS.muted, fontWeight: 600,
          }}>
